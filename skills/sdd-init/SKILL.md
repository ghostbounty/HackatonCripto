---
name: sdd-init
description: Inicializar o alinear la estructura base de un repositorio orientado a specification-driven development. Usar cuando se necesite crear o reparar la capa estructural del repo, verificar la presencia de docs, changes, skills, scripts, .atl o templates de colaboracion para un flujo alineado a GenLayer.
---

# Proposito

Inicializar la estructura operativa minima del repositorio sin romper `docs/product/` ni `changes/`, dejando el entorno listo para ejecucion autonoma prolongada y para slices de adjudicacion auditables.
...
2. Preservar `docs/product/` como contexto funcional historico.
3. Preservar `changes/` existentes como historial legado.
